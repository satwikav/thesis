...
use "/Users/satwikav/Documents/GitHub/thesis/BIHSRound3/Male/010_bihs_r3_male_mod_b1.dta",clear
keep a01 b1_02 mid b1_04b
rename mid mid_mother
rename b1_02 age_mother
rename b1_04b age_preg
...
use "/Users/satwikav/Documents/GitHub/thesis/BIHSRound3/Female/099_bihs_r3_female_mod_w1.dta", clear
keep a01 mid_w1 w1_04
rename mid_w1 mid_father
rename w1_04 height_father
...
eststo: quietly reg haz06 empw_female age_child age_2_child girl_child sibling age_mother height_mother edu_mother dep_ratio log_land trader_hhh animal_feces pipe_water sealed_toilet eat_soil open_garbage poorest_tercile richest_tercile i.dvcode
//main results regression 2
eststo: quietly reg waz06 empw_female age_child age_2_child girl_child sibling age_mother height_mother edu_mother dep_ratio log_land trader_hhh animal_feces pipe_water sealed_toilet eat_soil open_garbage poorest_tercile richest_tercile  i.dvcode
esttab, b(2) p(2) r2 ar2 star(* 0.10 ** 0.05 *** 0.01) wide compress 

//main results regression 1 
est clear  // clear the stored estimates
eststo: quietly reg haz06 empw_female age_child girl_child sibling age_mother height_mother height_father edu_mother dep_ratio log_land edu_hhh age_hhh trader_hhh animal_feces pipe_water sealed_toilet eat_soil open_garbage i.income_3 i.dvcode
//main results regression 2
eststo: quietly reg waz06 empw_female age_child girl_child sibling age_mother edu_mother dep_ratio log_land edu_hhh age_hhh trader_hhh animal_feces pipe_water sealed_toilet eat_soil open_garbage i.income_3 i.dvcode
esttab, b(2) p(2) r2 ar2 star(* 0.10 ** 0.05 *** 0.01) wide compress 
...
ivreg2 haz06 age_child age_2_child girl_child sibling age_mother height_mother edu_mother dep_ratio log_land trader_hhh animal_feces pipe_water sealed_toilet eat_soil open_garbage poorest_tercile richest_tercile i.dvcode (empw_female = mobility_score marr_choice), endog (empw_female)

gen empw_female_2 = empw_female ^ 2

//iv 2SLS
ivreg2 haz06 age_child age_2_child girl_child sibling age_mother height_mother edu_mother dep_ratio log_land edu_hhh age_hhh trader_hhh animal_feces pipe_water sealed_toilet eat_soil open_garbage i.income_3 i.dvcode (empw_female = mobility_score marr_choice), endog (empw_female)

ivreg2 waz06 age_child age_2_child girl_child sibling age_mother height_mother edu_mother dep_ratio log_land edu_hhh age_hhh trader_hhh animal_feces pipe_water sealed_toilet eat_soil open_garbage i.income_3 i.dvcode (empw_female = mobility_score marr_choice), endog (empw_female)

ivreg2 haz06 age_child age_2_child girl_child sibling age_mother height_mother edu_mother dep_ratio log_land edu_hhh age_hhh trader_hhh animal_feces pipe_water sealed_toilet eat_soil open_garbage i.income_3 i.dvcode (empw_female_2 = mobility_score marr_choice), endog (empw_female_2)

ivreg2 waz06 age_child age_2_child girl_child sibling age_mother height_mother edu_mother dep_ratio log_land edu_hhh age_hhh trader_hhh animal_feces pipe_water sealed_toilet eat_soil open_garbage i.income_3 i.dvcode (empw_female_2 = mobility_score marr_choice), endog (empw_female_2)
...
//iv 2SLS
ivreg2 haz06 age_child age_2_child girl_child sibling age_mother age_2_mother height_mother edu_mother dep_ratio log_land edu_hhh age_hhh trader_hhh animal_feces pipe_water sealed_toilet eat_soil open_garbage poorest_tercile richest_tercile i.dvcode (empw_female = mobility_score marr_choice), endog (empw_female)

ivreg2 waz06 age_child age_2_child girl_child sibling age_mother age_2_mother height_mother edu_mother dep_ratio log_land edu_hhh age_hhh trader_hhh animal_feces pipe_water sealed_toilet eat_soil open_garbage poorest_tercile richest_tercile i.dvcode (empw_female = mobility_score marr_choice), endog (empw_female)
...
est clear  
eststo: quietly reg DD empw_female age_child age_2_child girl_child sibling age_mother edu_mother dep_ratio log_land edu_hhh age_hhh trader_hhh dist_shop FD i.income_3 i.dvcode
eststo: quietly reg DD_1 empw_female age_child age_2_child girl_child sibling age_mother edu_mother dep_ratio log_land edu_hhh age_hhh trader_hhh dist_shop FD i.income_3 i.dvcode
eststo: quietly reg DD_new empw_female age_child age_2_child girl_child sibling age_mother edu_mother dep_ratio log_land edu_hhh age_hhh trader_hhh dist_shop FD i.income_3 i.dvcode
esttab, b(2) p(2) r2 ar2 star(* 0.10 ** 0.05 *** 0.01) wide compress 

ivreg2 DD age_child girl_child sibling age_mother edu_mother dep_ratio log_land edu_hhh age_hhh trader_hhh dist_shop abuse FD i.income_3 i.dvcode (empw_female = mobility_score marr_choice), endog (empw_female)
...
//iv 2SLS
ivreg2 DD age_2_child age_child girl_child age_mother age_hhh dep_ratio dist_shop edu_hhh edu_mother trader_hhh log_land FD i.income_3 i.dvcode sibling (empw_female = mobility_score marr_choice), endog (empw_female)
...
ivreg2 DD_new age_child age_2_child girl_child sibling age_mother edu_mother dep_ratio log_land edu_hhh age_hhh trader_hhh dist_shop FD poorest_tercile richest_tercile i.dvcode (empw_female = mobility_score marr_choice), endog (empw_female)
