...
set more off
cap log close
log using "logs\WEAI_calculation_Pilot_2.0_24hr_core.txt", text replace 


*** OPEN DATA FILE  
**************************************************

use "modifieddata\all_indicators_2.0_24hr.dta", clear
...
save "modifieddata\all_depr_indicators_2.0_24hr_core.dta", replace
...
save "modifieddata\individual_indices_`c'_2.0_24hr_core.dta", replace  // SAVES, FOR EACH COUNTRY, A DATASET WITH INDIVIDUAL DATA. //
...
save "modifieddata\results_`c'_`r'_2.0_24hr_core.dta", replace
...
use "modifieddata\all_depr_indicators_2.0_24hr_core.dta", clear
...
foreach var in credjanydec_any /*jrightanyagr*/ {
	gen w_`var'=1/15
	}
...
save "modifieddata\results_GPI_2.0_24hr_core.dta", replace
