...
set more off
cap log close
log using "logs\WEAI_calculation_Pilot_2.0_24hr.txt", text replace 
...
save "modifieddata\all_depr_indicators_2.0_24hr.dta", replace
...
save "modifieddata\individual_indices_`c'_2.0_24hr.dta", replace  // SAVES, FOR EACH COUNTRY, A DATASET WITH INDIVIDUAL DATA. //
...
save "modifieddata\results_`c'_`r'_2.0_24hr.dta", replace
...
use "modifieddata\all_depr_indicators_2.0_24hr.dta", clear
...
save "modifieddata\results_GPI_2.0_24hr.dta", replace
